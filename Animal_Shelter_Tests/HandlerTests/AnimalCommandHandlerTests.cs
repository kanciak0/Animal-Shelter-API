...
public class CreateAnimalCommandHandlerTests
{
    ...
    private IRequestHandler<CreateAnimalCommand, string> _createAnimalCommandHandler;
...
{
    private Mock<IAnimalRepository> _mockRepository;
    private IRequestHandler<DeleteAnimalCommand, string> _deleteAnimalCommandHandler;
    ...
    public async Task DeleteAnimalCommandHandler_DeletesAnimalFromRepository()
    {
        ...
        _mockRepository.Setup(r => r.GetByID(animalId.ToGuid()))
        ...
        _mockRepository.Verify(r => r.Delete(animalId.ToGuid()), Times.Once);
        _mockRepository.Verify(r => r.SaveChangesAsync(), Times.Once);
